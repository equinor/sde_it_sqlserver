DROP VIEW V_PI_HISTORY_SERVER_LAST_30;

/* Formatted on 28.05.2015 06:41:23 (QP5 v5.256.13226.35510) */
CREATE OR REPLACE FORCE VIEW V_PI_HISTORY_SERVER_LAST_30
(
   SERVER,
   LAST_CONNECTED,
   CONNECTION_COUNT
...
AS
     SELECT DISTINCT
      ...
      WHERE     LOWER (nodename) NOT LIKE 'pc%'
            ...
            AND LOWER (nodename) NOT LIKE 'st-ts%'
            AND LOWER (nodename) NOT LIKE 'vd%'
            AND LOWER (nodename) NOT LIKE '%whrgs%'
